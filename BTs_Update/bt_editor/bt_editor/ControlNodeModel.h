...
{
public:
    SequenceModel(): ControlNodeModelBase()
    { 
        _bt_node_type = BT::SEQUENCE;
        //std::cout << "Sequence Created: " << _bt_node_type << std::endl;
    }
...
public:
    ...
    {
        _bt_node_type = BT::SELECTOR;
        //std::cout << "Selector Created: " << _bt_node_type << std::endl;
    }
    int BTType()
    {
        return BT::SELECTOR;
...
public:
    ...
    static QString staticName() { return QString("ExParallel"); }
};
