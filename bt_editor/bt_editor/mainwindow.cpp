    ...
    _root_node(nullptr)
{
    ...
    ret->registerModel<Search>("Action");
    ret->registerModel<IsFind>("Condition");

    ret->registerModel<Pick>("Action");
    ret->registerModel<IsObjectOnHand>("Condition");
    ret->registerModel<IsHandEmpty>("Condition");
    ret->registerModel<IsPathToObject>("Condition");

    ret->registerModel<Place>("Action");
    ret->registerModel<IsObjectOnDestination>("Condition");
    ret->registerModel<IsPathToDestination>("Condition");
...
void MainWindow::loadInitialTree()
{
    ...
    fileName = fileName.append("/update.xml");
}
