...
BT::TreeNode *getBTObject(QtNodes::FlowScene &scene, QtNodes::Node &node)
{
    ...
    case BT::PICK:
    {
        QString s = node.nodeDataModel()->get_line_edit();
        QStringList ss = s.split(",");

        BT::Pick* bt_node = new BT::Pick(ss[0].toStdString(), ss[1].toStdString());
    ...
    case BT::HOLD:
    {
        ...
        BT::Hold* bt_node = new BT::Hold(ss[0].toStdString(), ss[1].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::HANDEMPTY:
    {
        BT::HandEmpty* bt_node = new BT::HandEmpty(node.nodeDataModel()->get_line_edit().toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::APPROACH:
    {
        ...
        BT::Approach* bt_node = new BT::Approach(ss[0].toStdString(), ss[1].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::PLACE:
    {
        ...
        BT::Place* bt_node = new BT::Place(ss[0].toStdString(), ss[1].toStdString(), ss[2].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::ON:
    {
        ...
        BT::On* bt_node = new BT::On(ss[0].toStdString(), ss[1].toStdString(), ss[2].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::MOVETO:
    {
        ...
        BT::MoveTo* bt_node = new BT::MoveTo(node.nodeDataModel()->get_line_edit().toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::NEAR:
    {
        ...
        BT::Near* bt_node = new BT::Near(ss[0].toStdString(), ss[1].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::EXISTPATH:
    {
        BT::ExistPath* bt_node = new BT::ExistPath(node.nodeDataModel()->get_line_edit().toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::REMOVE:
    {
        ...
        BT::Remove* bt_node = new BT::Remove(ss[0].toStdString(), ss[1].toStdString(), ss[2].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::DROP:
    {
        ...
        BT::Drop* bt_node = new BT::Drop(ss[0].toStdString(), ss[1].toStdString());
        node.linkBTNode(bt_node);
        return bt_node;
    }
    case BT::SEQUENCE:
